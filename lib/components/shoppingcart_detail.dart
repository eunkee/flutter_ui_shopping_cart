...
import 'package:flutter_ui_shoppingcart/constants.dart';
...
class ShoppingCartDetail extends StatelessWidget {
  ...
  // 4. 다른 화면에서도 재사용하면 공통 컴포넌트 위젯으로 관리
  Widget _buildDetailIcon(Color mColor) {
    return Padding(
      padding: const EdgeInsets.only(right: 10),
      // 5. Stack의 첫 번째 Container 위젯 위에 Positioned 위젯이 올라가는 형태
      child: Stack(
        children: [
          Container(
            width: 50,
  ...
  // 6. 다른 화면에서도 재사용하려면 함수가 아닌 공통 컴포넌트 위젯으로 관리
